        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
          <div className="max-w-xl">
            <h2 className="text-4xl sm:text-5xl font-black text-primary leading-[1.08] tracking-tight mb-3">
              Ready to turn data
              <br />
              <span className="text-accent">into decisions?</span>
            </h2>
            <p className="text-lg text-black leading-relaxed">
              Every case study on this page started with a single conversation.
              Tell us your business question — we'll tell you exactly how we'd
              answer it.
            </p>
          </div>
